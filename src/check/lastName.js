function lastName(lastname, selector) {
    if (!lastname.length) {
        document.querySelector(`#${selector}`).className = '';
        document.querySelector(`#${selector}`).innerHTML = 'Last name field is empty';
    ...
    if (!lengthLimit(lastname)) {
        document.querySelector(`#${selector}`).className = '';
        document.querySelector(`#${selector}`).innerHTML = 'Last name Is not valid';
        document.querySelector(`#${selector}`).classList.add('notValid');
